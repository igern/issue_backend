...
pub fn delete_directory_status_test() {
...
pub fn delete_directory_status_not_found_test() {
  use t <- utils.with_context
...
pub fn delete_directory_status_not_member_of_directory_test() {
  use t <- utils.with_context
...
pub fn delete_directory_status_missing_authorization_header_test() {
...
pub fn delete_directory_status_invalid_bearer_format_test() {
  utils.invalid_bearer_format_tester(http.Delete, "/api/directory-statuses/1")
}

pub fn delete_directory_status_invalid_jwt_test() {
  utils.invalid_jwt_tester(http.Delete, "/api/directory-statuses/1")
}

pub fn delete_directory_status_profile_required_test() {
  utils.profile_required_tester(http.Delete, "/api/directory-statuses/1")
}
